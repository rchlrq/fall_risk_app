...
Future<void> shareCSV() async {
  ...
  void initState() {
    ...
    _initializeCamera();
    requestPermissions().then((_) => connectToDevice());
  }
  ...
  children: [
    ElevatedButton(
      onPressed: _isRecording ? _toggleRecording : (!_hasRecorded ? _toggleRecording : _toggleRecording),
...
// Sensor logging buttons using your existing methods and state:
Text('Sensor Data Logger', style: TextStyle(fontWeight: FontWeight.bold)),
SizedBox(height: 10),
Row(
  mainAxisAlignment: MainAxisAlignment.center,
  children: [
